...
export const groupTracksByParent = (tracks: RawTrackProps[], trackRowIndex: number) => {
...
export const computeGroupDataForEdObject = (
    edObject: RawObjectProps,
    rowIndex: number
  ): ComputedGroupData => {
    const { tracks } = edObject;
