...
const TrackSegmentEditor = () => {
    ...
    const firstKeyframe = useTimelineManagerAPI(state => state.tracks[trackKey]?.keyframes[selectedTrackSegment.firstKeyframeKey])
    const secondKeyframe = useTimelineManagerAPI(state => state.tracks[trackKey]?.keyframes[selectedTrackSegment.secondKeyframeKey])
