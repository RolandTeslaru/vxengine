  ...
  return (
    <PopoverPrimitive.Portal container={externalContainer}>
      <PopoverPrimitive.Content
        ...
        className={cn(
          `backdrop-blur-sm z-50 w-72 rounded-xl border-[1px] border-neutral-600 border-opacity-80 
           bg-opacity-80 bg-neutral-950  p-2 text-popover-foreground shadow-lg shadow-neutral-950 outline-none 
