  ...
  return (
    <ContextMenuPrimitive.Portal container={externalContainer}>
      <ContextMenuPrimitive.Content
        ref={ref}
        className={cn(
          `z-50 min-w-[8rem] overflow-y-auto backdrop-blur-sm rounded-lg border border-neutral-600 bg-neutral-700 bg-opacity-80 p-1 text-popover-foreground shadow-lg shadow-neutral-950
         data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 
