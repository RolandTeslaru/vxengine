...
interface Props {
    id:string
    isAttached: boolean
    setAttach: (id: string, value: boolean) => void
    setMount: (id: string, value: boolean) => void
}

export const WindowControlDots: React.FC<Props> = ({ isAttached, setAttach, setMount, id }) => {
    const handleAttachChange = () => setAttach(id, !isAttached)
    return (
        <div className="absolute top-0 left-1/2 -translate-x-1/2">
            <Popover>
                ...
                <PopoverContent sideOffset={0} className="w-40 p-1 text-sm font-sans-menlo border-neutral-600 bg-neutral-700 "
                >
                    <div
                        className="cursor-pointer hover:bg-neutral-800 p-2 rounded-lg flex flex-row"
                    ...
                    <div
                        className="cursor-pointer hover:bg-neutral-800 p-2 rounded-lg flex flex-row text-red-600"
                        onClick={() => setMount(id, false)}
                    >
