...
export const WindowControlDots: React.FC<Props> = ({ isAttached, id }) => {
    ...
    const handleAttachChange = () => setWindowAttachment(id, !isAttached)
            ...
            <Popover>
                ...
                >
                    ...
                    <PopoverItem
                        ...
                        onClick={() => setWindowVisibility(id, false)}
                        icon={
