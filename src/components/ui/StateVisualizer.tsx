    ...
    return (
        <>
            <div className="w-full flex flex-row pb-1">
                <h1 className="text-left ml-2 font-roboto-mono">
                    State Visualizer
                </h1>
                <button className={" border right-2 absolute ml-auto text-xs p-[2px] h-fit w-fit flex hover:bg-neutral-800 border-neutral-600/20 rounded-2xl cursor-pointer "}
