...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@vxengine/ui/foundations/select";
  ...
  return (
    <>
      <div className="w-full flex flex-row pb-1">
        <h1 className="text-left ml-2 font-medium font-roboto-mono text-label-primary">State Visualizer</h1>
        <button
